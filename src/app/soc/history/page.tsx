    ...
    <div className="p-6 lg:p-8 space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">Complete forensic scan archive with filtering and export</p>
        </div>
        <div className="flex gap-2">
          <button onClick={handleExport} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-100 dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.06] text-slate-500 hover:text-slate-700 dark:hover:text-neutral-300 transition-all text-xs font-mono shadow-sm">
      ...
      <div className="glass-card p-4 shadow-sm">
        <div className="flex flex-wrap items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono text-slate-400 uppercase tracking-widest">Filters</span>
          </div>
          ...
          <select
            ...
            className="bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-white/[0.08] rounded-lg px-3 py-1.5 text-xs font-mono text-slate-600 dark:text-neutral-400 focus:outline-none focus:border-emerald-500/30"
          >
          ...
          <div className="ml-auto flex items-center gap-3">
            <span className="text-[10px] font-mono text-slate-400">TOTAL: {scans.length}</span>
