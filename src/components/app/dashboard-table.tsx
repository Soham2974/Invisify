...
const severityIcons = {
  ...
  Low: <ShieldAlert className="h-4 w-4 text-emerald-500" />,
  Medium: <ShieldAlert className="h-4 w-4 text-amber-500" />,
  High: <ShieldAlert className="h-4 w-4 text-rose-500" />,
  Critical: <ShieldAlert className="h-4 w-4 text-rose-500" />,
};
      ...
      <DialogContent className="sm:max-w-3xl bg-neutral-900/95 backdrop-blur-3xl border-white/10 text-white rounded-[2rem] overflow-hidden p-0 gap-0 shadow-[0_0_100px_rgba(0,0,0,0.5)]">
        ...
        <ScrollArea className="max-h-[70vh]">
          <div className="px-8 pb-8 space-y-8">
            ...
            {log.severity !== 'Safe' && log.severity !== 'Low' && (
